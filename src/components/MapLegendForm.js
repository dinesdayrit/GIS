...
const MapLegendForm = () => {
  return (
    <div className={styles.legend}>
      ...
      <p style={{color: "black", fontWeight: 'bold'}}> - FOR APPROVAL</p>
      </div>

      <div style={{display: 'flex', marginBottom: '5px' }}>
      <span style={{background: 'blue',color: "blue", marginRight: '2px'}}>color</span>
      <p style={{color: "black", fontWeight: 'bold'}}> - PLOT APPROVED</p>
      </div>

      <div style={{display: 'flex', marginBottom: '5px' }}>
      <span style={{background: 'yellow',color: "yellow", marginRight: '2px'}}>color</span>
      <p style={{color: "black", fontWeight: 'bold'}}> - PIN FOR APPROVAL</p>
      </div>

      <div style={{display: 'flex', marginBottom: '5px' }}>
      <span style={{background: 'green',color: "green", marginRight: '2px'}}>color</span>
      <p style={{color: "black", fontWeight: 'bold'}}> - PIN APPROVED</p>
      </div>
    </div>
  );
};
